          ...
          <div className="flex items-center gap-3 mb-4">
            ...
            <div className="flex-1">
              ...
              <p className="mt-1 text-base text-neutral-600">
                Edytuj szczegóły członka biblioteki
              </p>
            </div>
          </div>
          ...
          >
            <div className="space-y-2">
              ...
              <input
                ...
                disabled={submitting}
                className="w-full min-h-12 rounded-xl border border-neutral-300 bg-neutral-50 px-4 py-3 text-base outline-none transition focus:border-blue-500 focus:ring-2 focus:ring-blue-100 focus:bg-white disabled:opacity-70"
